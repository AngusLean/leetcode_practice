...
public class QA_5_PracticeTest {
    ...
    public void init() {
        testData = new ArrayList<Tuple3<Tuple<int[], Integer>, int[], int[]>>() {{
            add(new Tuple3<>(new Tuple<>(new int[]{1, 3, 4, 0, 0, 0}, 3), new int[]{3, 4, 5}, new int[]{1, 3, 3, 4, 4, 5}));
            add(new Tuple3<>(new Tuple<>(new int[]{1, 0, 0, 0, 0}, 1), new int[]{2, 3, 4, 5}, new int[]{1, 2, 3, 4, 5}));
            add(new Tuple3<>(new Tuple<>(new int[]{1, 1, 1, 2, 3, 0, 0}, 5), new int[]{1, 2}, new int[]{1, 1, 1, 1, 2, 2, 3}));
        }};
    }
